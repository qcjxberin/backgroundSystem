<template>
    <div class="swaperWarp">
        <div class="condition">
            <div class="condition-top">医生信息列表</div>
            <div class="condition-bottom">
                <Form :model="formItem" :label-width="80" inline>
                    <FormItem label="医生id">
                        <Input v-model="formItem.doctorId" placeholder="请输入医生id" size="small"></Input>
                    </FormItem>
                    <FormItem :label-width="0">
                        <Button type="info" size="small">查询</Button>
                        <Button style="margin-left: 8px" size="small">重置</Button>
                    </FormItem>
                </Form>
            </div>
        </div>
...
<script lang='ts'>
	...
	export default class DoctorManagementList extends Vue {
		...
		protected formItem: object = {
			doctorId: ''
		}

		protected mounted () {
			console.log('DoctorManagementList')
		}
	}
</script>
